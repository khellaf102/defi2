...
import "github.com/OpenZeppelin/openzeppelin-solidity/contracts/math/SafeMath.sol";
    ...
    contract Voting is Ownable {
        ...
        uint private winningProsalId; //Id du gagnant (l'index de la proposition )
...
//5_l'administrateur let fin a la session du vote 
    ...
    function hcompteVotes() public onlyOwner  VotingSessionEnd() 
    {
        ...
        uint winnigproposalIndex=0;
            ...
            winningProsalId=winnigproposalIndex;//winnigproposalIndex deja declaré au debut du contrat
